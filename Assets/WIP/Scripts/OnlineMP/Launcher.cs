...
namespace Com.UnsungHeroes.CreedOfWar
{
    public class Launcher : MonoBehaviourPunCallbacks
    {
        ...
        public void Connect()
        {
            ...
            {
                // #Critical we need at this point to attempt joining a Random Room. If it fails, we'll get notified in
